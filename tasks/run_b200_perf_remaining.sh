#!/bin/bash
# B200 remaining perf benchmarks (C5_512K, C5_1M, C6_128K-1M)
...
run_perf() {
    ...
    python3 -m sglang.launch_server \
        ...
        $extra \
        --host 0.0.0.0 --port $PORT > /tmp/${tag}_server.log 2>&1 &
...
echo "ALLDONE" > /output/replicate_qproj_bench/B200_DONE
echo "All B200 remaining perf benchmarks complete"
