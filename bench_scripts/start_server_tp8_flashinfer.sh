...
export BACKEND=flashinfer
export CONTEXT_LENGTH=163840
export MAX_CC=512
SGLANG_DCP_SYMM_ONLY=true NCCL_DEBUG=WARN PYTHONUNBUFFERED=1 TORCHINDUCTOR_FX_GRAPH_CACHE=1 \
	...
	--context-length $CONTEXT_LENGTH --attention-backend $BACKEND --disable-radix-cache   --enable-symm-mem
